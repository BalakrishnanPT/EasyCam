...
import in.balakrishnan.cameramodule.camera.CameraControllerViewModel;
import in.balakrishnan.cameramodule.camera.CaptureData;
import in.balakrishnan.cameramodule.camera.FileUtils;
import in.balakrishnan.cameramodule.camera.StatusBarUtil;
import in.balakrishnan.cameramodule.camera.capture.NumberToWords;

import java.io.File;
import java.util.ArrayList;
import java.util.List;

import static in.balakrishnan.cameramodule.camera.BitmapHelper.calculateInSampleSize;
